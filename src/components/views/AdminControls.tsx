...
import { 
  Users, Shield, Key, Bell, Database, 
...
const USERS_DATA = [
  { name: 'Dr. Elena Fisher', email: 'elena.fisher@merck.com', role: 'Super Admin', status: 'Active', lastLogin: '2026-05-18' },
  ...
  return (
    ...
    >
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
        <div className="merck-card p-6 flex items-center justify-between col-span-1">
          <div className="flex items-center gap-3">
                  ...
                  <tr key={idx} className="border-b border-slate-50 last:border-0 hover:bg-slate-50/50 transition-colors group">
                    ...
                    <td className="px-8 py-4">
                      <span className={cn(
                        ...
                        user.role === 'Super Admin' ? "bg-merck-indigo/5 text-merck-indigo border-merck-indigo/10" :
      ...
      {activeTab === 'roles' && (
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {[
            { role: 'Super Admin', desc: 'Full access to all features, settings, and user management', permissions: ['Manage Users', 'Configure Settings', 'View All Data', 'Export Reports', 'Delete Records'], count: 1 },
